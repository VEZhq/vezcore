  ...
  return (
    <section className="mb-6 space-y-3">
      <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_280px]">
        <div className="relative border border-white/[0.06] light:border-black/[0.08] bg-[#141310]/[0.74] light:bg-[#fffdfa]/[0.84] p-3 backdrop-blur-md">
          ...
          {open && (
            <div className="absolute left-3 right-3 top-[62px] z-30 border border-white/[0.08] light:border-black/[0.08] bg-[#070707] light:bg-white p-1.5 shadow-2xl">
        ...
        {access.canAccessInfrastructure ? (
          ...
          <div className="border border-white/[0.06] light:border-black/[0.08] bg-[#141310]/[0.66] light:bg-[#fffdfa]/[0.84] p-3 backdrop-blur-md">
      ...
      <div className={`grid gap-3 ${showRecent ? 'lg:grid-cols-[minmax(0,1fr)_320px]' : ''}`}>
        {showSession && (
        <div className="grid grid-cols-2 gap-2 border border-white/[0.06] light:border-black/[0.08] bg-[#141310]/[0.66] light:bg-[#fffdfa]/[0.84] p-3 backdrop-blur-md sm:grid-cols-4">
          {[
        ...
        <div className="border border-white/[0.06] light:border-black/[0.08] bg-[#141310]/[0.66] light:bg-[#fffdfa]/[0.84] p-3 backdrop-blur-md">
          ...
          <div className="mt-2 grid gap-1">
            {allowedRecentPages.length === 0 ? (
              ...
              allowedRecentPages.slice(0, 2).map((page) => (
                <Link
